...
do
  ...
  cheqd-noded add-genesis-account "operator-$i" 20000000000000000zarx --keyring-backend "test" --home "${NODE_HOME}"
  ...
  cheqd-noded gentx "operator-$i" 1000000000000000zarx --chain-id "${CHAIN_ID}" --node-id "${NODE_ID}" \
