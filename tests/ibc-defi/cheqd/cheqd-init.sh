...
# Config
sed -i $SED_EXT 's|minimum-gas-prices = ""|minimum-gas-prices = "50zarx"|g' "$HOME/.cheqdnode/config/app.toml"
...
cheqd-noded add-genesis-account cheqd-user 1000000000000000000zarx --keyring-backend test
cheqd-noded gentx cheqd-user 10000000000000000zarx --chain-id $CHAIN_ID --pubkey "$NODE_0_VAL_PUBKEY" --keyring-backend test
