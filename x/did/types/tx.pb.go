...
type MsgCreateDidDocPayload struct {
	...
	Accept               []string              `protobuf:"bytes,13,rep,name=accept,proto3" json:"accept,omitempty"`
	RoutingKeys          []string              `protobuf:"bytes,14,rep,name=routing_keys,json=routingKeys,proto3" json:"routing_keys,omitempty"`
}
...
func (m *MsgCreateDidDocPayload) GetAccept() []string {
	if m != nil {
		return m.Accept
	}
	return nil
...
func (m *MsgCreateDidDocPayload) GetRoutingKeys() []string {
	if m != nil {
...
func (m *MsgUpdateDidDocPayload) GetAccept() []string {
	if m != nil {
		return m.Accept
	}
	return nil
...
func (m *MsgUpdateDidDocPayload) GetRoutingKeys() []string {
	if m != nil {
		return m.RoutingKeys
	}
	return nil
...
var fileDescriptor_0e353aae8dd04717 = []byte{
	...
	,
}
...
func (m *MsgCreateDidDocPayload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RoutingKeys) > 0 {
		for iNdEx := len(m.RoutingKeys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.RoutingKeys[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
	if len(m.Accept) > 0 {
		for iNdEx := len(m.Accept) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.Accept[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
